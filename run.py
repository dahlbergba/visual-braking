...
population = Microbial(fitnessFunction2, Population, GenotypeLength, RecombProb, MutatProb)
population.run(Tournaments)
filename = 'FinalDistanceNoCrash2_G%i_V%i_%s' % ( int(population.generationsRun), optical_variable, population.dateCreated )
