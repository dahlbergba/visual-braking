...
class analyzedData():
    ...
    def popAnalysis(self):
        ...
        self.top25FitnessMean = np.average(np.sort(fits)[self.data.popsize-25:])
...
position_perturbations[int(interval/Dt)] = 15
position_perturbations[int(interval*2/Dt)] = -4
position_perturbations[int(interval*3/Dt)] = 5
position_perturbations[int(interval*4/Dt)] = -12

# Creating velocity perturbations
interval = 2.5

velocity_perturbations = np.zeros(int(50/Dt))
velocity_perturbations[int(interval/Dt)] = 6
velocity_perturbations[int(interval*2/Dt)] = -7
velocity_perturbations[int(interval*3/Dt)] = 3
velocity_perturbations[int(interval*4/Dt)] = -1
